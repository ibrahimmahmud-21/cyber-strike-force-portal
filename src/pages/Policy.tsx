      ...
      <section className="relative overflow-hidden px-6 py-20">
        ...
        <div className="relative mx-auto max-w-3xl">
          <div className="text-center reveal">
            <p className="font-orbitron text-[11px] uppercase tracking-[0.3em] text-[#00d4ff]">// Operational Rules</p>
            <h1 className="font-orbitron mt-4 text-3xl font-black text-white sm:text-4xl" style={{ letterSpacing: "3px" }}>
          ...
          <div className="mt-12 space-y-5">
            {sections.map((s, i) => (
              <article key={s.t} className="reveal pillar-card" style={{ transitionDelay: `${i * 70}ms` }}>
                ...
                <p className="mt-4 text-[15px] text-[#cbd3e1]" style={{ lineHeight: 1.85, letterSpacing: "normal", wordSpacing: "normal", textAlign: "left", hyphens: "none" }}>
                  {s.d}
                </p>
              </article>
            ))}
